...
const redisPort = process.env.REDIS_PORT || '6700';
const redisClient = redis.createClient(redisPort, redisHost);

const rateLimitWindowMS = 60000; // Sets window to 1 minute
const rateLimitNumRequests = 45; // Limits the number of 45 reqs per minute
